...
export default function Cursor() {
    ...
    return (
        <div
            ref={cursorRef}
            className="hidden md:flex fixed top-0 left-0 w-3 h-3 bg-white rounded-full pointer-events-none z-[10001] mix-blend-difference items-center justify-center"
            style={{
